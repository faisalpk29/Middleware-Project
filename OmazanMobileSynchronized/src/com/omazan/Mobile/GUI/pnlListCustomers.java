...
public class pnlListCustomers extends JOmazanPanel {
	...
	public void LoadCustomers()
	{
		...
		List<Customer> customers = CustomerBL.ListCustomers(GetPU());
	...
	public void SearchCustomers()
	{
		...
		List<Customer> customers = CustomerBL.SearchCustomer(GetPU(),txtFirstName.getText(), txtLastName.getText(), txtUsername.getText());
		if( customers != null && customers.size() > 0)
		{
			for(Customer customer : customers)
			{
	...
	public pnlListCustomers() {
		...
		scrollPane.setBounds(10, 174, 757, 150);
		add(scrollPane);
