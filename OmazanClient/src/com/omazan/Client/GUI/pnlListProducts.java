...
public class pnlListProducts extends JPanel {
	...
	public void LoadProducts()
	{
		...
		List<Product> products = Business.ListProducts();
	...
	public void SearchProducts()
	{
		...
		List<Product> products = Business.SearchProduct(txtCode.getText(), txtName.getText());
		if( products != null && products.size() > 0)
		{
			for(Product product : products)
			{
	...
	public void EditProduct()
	{
		...
		if( selectedRowindex >= 0)
		{
			...
			com.omazan.Client.GUI.frmMain.ApplicationForm.ShowEditProductDialog(pID);
		}
	}

	public void CreateNewProduct()
	{
		com.omazan.Client.GUI.frmMain.ApplicationForm.ShowAddProductDialog();
	}
