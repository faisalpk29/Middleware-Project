...
public class pnlListCustomers extends JPanel {
	...
	public void LoadCustomers()
	{
		...
		List<Customer> customers = Business.ListCustomers();
	...
	public void SearchCustomers()
	{
		...
		List<Customer> customers = Business.SearchCustomer(txtFirstName.getText(), txtLastName.getText(), txtUsername.getText());
		if( customers != null && customers.size() > 0)
		{
			for(Customer customer : customers)
			{
	...
	public void EditCustomer()
	{
		...
		if( selectedRowindex >= 0)
		{
			...
			com.omazan.Client.GUI.frmMain.ApplicationForm.ShowEditCustomerDialog(CustomerID);
		}
	}
	
	public void CreateNewCustomer()
	{
		com.omazan.Client.GUI.frmMain.ApplicationForm.ShowAddCustomerDialog();
	}
