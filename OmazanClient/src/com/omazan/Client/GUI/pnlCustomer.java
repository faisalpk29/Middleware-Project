...
public class pnlCustomer extends JPanel {
	...
	public void setCustomerID(int customerID) {
		...
		Customer customer = Business.GetCustomer(customerID);
		if( customer != null )
		{
	...
	public void AddCustomer() {
		...
		if (CustomerID <= 0) {
			if( Business.GetCustomerByUsename(txtUsername.getText()) != null)
			{
				JOptionPane.showMessageDialog(null,
						"Customer with same username already exist.");
				return;
			}
			if (Business.AddCustomer(customer)) {
				JOptionPane.showMessageDialog(null,
						"Customer added successfully.");
				com.omazan.Client.GUI.frmMain.ApplicationForm.ShowListCustomerDialog();
			} else {
				JOptionPane.showMessageDialog(null, "Could not add customer.");
			}
		} else {
			customer.setID(CustomerID);
			if (Business.UpdateCustomer(customer)) {
				JOptionPane.showMessageDialog(null,
